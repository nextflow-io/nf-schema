...
"""
    ...
    def 'should fail with draft 2020_12 in limited mode' () {
        given:
        def schema = Path.of('src/testResources/nextflow_schema.json').toAbsolutePath().toString()
        def SCRIPT = """
            include { validateParameters } from 'plugin/nf-schema'
    ...
    def 'should validate with custom parameter meta schema in limited mode' () {
        given:
        def schema = Path.of('src/testResources/nextflow_schema_custom_param_meta_schema.json').toAbsolutePath().toString()
        def SCRIPT = """
            params.input = 'src/testResources/correct.csv'
            params.outdir = 'src/testResources/testDir'
            include { validateParameters } from 'plugin/nf-schema'
    ...
    def 'should validate with custom parameter meta schema in unlimited mode' () {
        given:
        def schema = Path.of('src/testResources/nextflow_schema_custom_param_meta_schema.json').toAbsolutePath().toString()
        def SCRIPT = """
            params.input = 'src/testResources/correct.csv'
    ...
    def 'should validate with custom parameter meta schema in limited mode - failure' () {
        given:
        def schema = Path.of('src/testResources/nextflow_schema_custom_param_meta_schema.json').toAbsolutePath().toString()
        def SCRIPT = """
            include { validateParameters } from 'plugin/nf-schema'
